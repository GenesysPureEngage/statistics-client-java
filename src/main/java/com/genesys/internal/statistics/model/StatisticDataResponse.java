 ...
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-02-26T22:31:23.066Z")
public class StatisticDataResponse {
  ...
  **/
  ...
  public StatisticDataResponse errors(List<ErrorResponse> errors) {
    this.errors = errors;
    return this;
  }

  public StatisticDataResponse addErrorsItem(ErrorResponse errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public StatisticDataResponse status(ResponseStatus status) {
    this.status = status;
    return this;
  }
