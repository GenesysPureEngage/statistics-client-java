...
public class StatisticsApi {
     ...
     */
    public com.squareup.okhttp.Call createSubscriptionUsingPOSTCall(String statistics, String verbose, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createSubscriptionUsingPOSTValidateBeforeCall(String statistics, String verbose, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public StatisticDataResponse createSubscriptionUsingPOST(String statistics, String verbose) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<StatisticDataResponse> createSubscriptionUsingPOSTWithHttpInfo(String statistics, String verbose) throws ApiException {
    ...
    /**
     * Opens the stat server subscription for the specified set of statistics. The statistic updates will be delivered via comet. Alternatively they can be peeked using corresponding API. (asynchronously)
     * 
     * @param statistics definitions for statistics which are to be opened with stat server (required)
     * @param verbose Verbose level for response (optional, default to INFO)
     ...
     */
    public com.squareup.okhttp.Call createSubscriptionUsingPOSTAsync(String statistics, String verbose, final ApiCallback<StatisticDataResponse> callback) throws ApiException {
     ...
     * @param verbose verbose (optional, default to INFO)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getStatValuesCall(String statistics, String verbose, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = statistics;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getStatValuesValidateBeforeCall(String statistics, String verbose, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStatValuesCall(statistics, verbose, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PeekedStatisticsResponse getStatValues(String statistics, String verbose) throws ApiException {
        ApiResponse<PeekedStatisticsResponse> resp = getStatValuesWithHttpInfo(statistics, verbose);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PeekedStatisticsResponse> getStatValuesWithHttpInfo(String statistics, String verbose) throws ApiException {
        com.squareup.okhttp.Call call = getStatValuesValidateBeforeCall(statistics, verbose, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getStatValuesAsync(String statistics, String verbose, final ApiCallback<PeekedStatisticsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getStatValuesValidateBeforeCall(statistics, verbose, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PeekedStatisticsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
