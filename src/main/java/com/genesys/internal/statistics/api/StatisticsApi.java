...
public class StatisticsApi {
     ...
     * @param statistics Definitions of the statistics to be monitored. (required)
     ...
     * @param objectId The type of object the statistic is for. (required)
     * @param objectType The ID of the object. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     * @param statistics The set of statistics you want to get the values for from Stat Server. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
